...
//2.定义数据抓取的scrape的集合
var scrapers = map[collector.Scrapes]bool{
	collector.MemScraper{}:true,
}
func main()  {
	scraperFlag := map[collector.Scrapes]*bool{}
...
`)
	...
	enabledScrapers :=[]collector.Scrapes{}
...
func newHandler(metric collector.Metrics,scrapers []collector.Scrapes,logger log.Logger) http.HandlerFunc{
